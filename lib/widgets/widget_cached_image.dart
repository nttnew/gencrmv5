...
class WidgetCachedImage extends StatelessWidget {
  WidgetCachedImage(
      {this.url, this.color, this.fit, this.icon, this.height, this.width});
      ...
      child: ClipRRect(
        ...
        child: Center(
          child: CachedNetworkImage(
            ...
            errorWidget: (context, url, error) => WidgetContainerImage(
        ...
        child: Center(
          child: CachedNetworkImage(
            ...
            errorWidget: (context, url, error) =>
                WidgetContainerImage(image: IMAGES.LOGO_APP),
          ),
        ),
      ),
    );
