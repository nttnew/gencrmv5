...
class GetJobChanceBloc extends Bloc<GetJobChanceEvent, JobChanceState> {
  ...
  GetJobChanceBloc({required UserRepository userRepository})
      : userRepository = userRepository,
        super(InitGetJobChance());
  ...
  static GetJobChanceBloc of(BuildContext context) =>
      BlocProvider.of<GetJobChanceBloc>(context);
}
