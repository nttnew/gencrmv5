...
class JobContractBloc extends Bloc<JobContractEvent,JobContractState>{
  ...
  JobContractBloc({required UserRepository userRepository}) : userRepository = userRepository, super(InitJobContractState());
  @override
  ...
  static JobContractBloc of(BuildContext context) => BlocProvider.of<JobContractBloc>(context);
}