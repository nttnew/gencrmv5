...
class DetailSupportBloc extends Bloc<DetailSupportEvent, DetailSupportState>{
  ...
  DetailSupportBloc({required UserRepository userRepository}) : userRepository = userRepository, super(InitGetDetailSupport());
  ...
  static DetailSupportBloc of(BuildContext context) => BlocProvider.of<DetailSupportBloc>(context);
}