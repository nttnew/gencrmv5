...
class DetailWorkBloc extends Bloc<DetailWorkEvent,DetailWorkState>{
  ...
  DetailWorkBloc({required UserRepository userRepository}) : userRepository = userRepository, super(InitGetDetailWorkState());
  @override
  ...
  static DetailWorkBloc of(BuildContext context) => BlocProvider.of<DetailWorkBloc>(context);
}