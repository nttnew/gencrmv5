...
class Handle<T> {
  ...
  static String? getPath(Map<String, String> path) =>
      path[PreferencesKey.BASE_URL];

  static findItemArrayObject(_elements) => _elements
      .firstWhere((element) => element['isAdmin'] == true, orElse: () => null);

  static findIndexArrayObject(elements) =>
      elements.lastIndexWhere((item) => item['isAdmin'] == true);
