...
class _RestClient implements RestClient {
  ...
  Future<QuickCreateResponse> getSearchQuickCreate(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<QuickCreateResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'modules/genmobile2/quickCreate/search',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = QuickCreateResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AddCustomerIndividual> getFormPayment(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'modules/genmobile2/contract/formPayment',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<BaseResponse> addPayment(map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'modules/genmobile2/contract/addPayment',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<BaseResponse> updatePayment(map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'modules/genmobile2/contract/udpatePayment',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<BaseResponse> deletePayment(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'modules/genmobile2/contract/deletePayment',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<QrCodePaymentRes> getQRCode(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'modules/genmobile2/payment/generateQrcode',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
