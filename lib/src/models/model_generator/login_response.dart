...
class InfoUserLogin {
  ...
  InfoUserLogin(
      ...
      this.phone,
      this.dia_chi,
      this.enable_callcenter); //static const empty =  InfoUserLogin('', '', '', '', '', '', '', 0);

  factory InfoUserLogin.fromJson(Map<String, dynamic> json) => _$InfoUserLoginFromJson(json);
...
class LoginData {
  ...
  LoginData({this.tien_te,this.info_user, this.token,this.session_id,this.menu});
