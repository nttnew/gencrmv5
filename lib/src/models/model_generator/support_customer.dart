...
class SupportCustomerData {
  final String? id,name,status,status_id,start_date,user_handling,color,total_note;


  SupportCustomerData(
      this.id, this.name, this.status, this.status_id, this.start_date,this.user_handling,this.color,this.total_note);
