...
class JobCustomerData {
  final String? id,name,status,status_id,start_date,user,color,total_note;


  JobCustomerData(
      this.id, this.name, this.status, this.status_id, this.start_date,this.user,this.color,this.total_note);
