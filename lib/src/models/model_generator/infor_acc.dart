...
class InforAcc {
  ...
  factory InforAcc.fromJson(Map<String, dynamic> json) => _$InforAccFromJson(json);
...
class InforAccResponse  extends BaseResponse{
  ...
  factory InforAccResponse.fromJson(Map<String, dynamic> json) => _$InforAccResponseFromJson(json);
