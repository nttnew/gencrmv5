...
class AppNavigator {
  ...
  static navigateAddServiceVoucher() async => await Get.toNamed(ROUTE_NAMES.ADDSERVICEVOUCHER);

  static navigateAddServiceVoucherStepTwo() async => await Get.toNamed(ROUTE_NAMES.ADDSERVICEVOUCHERSTEPTWO);
