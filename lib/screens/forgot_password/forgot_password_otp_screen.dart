                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                children: [
                                  Text("Xác thực tài khoản",style: TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.bold,fontSize: 20),),
                                  SizedBox(height: 5,),
                                  Text("Vui lòng nhập mã OTP được gửi đến email:",style: TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.w400,fontSize: 12),),
                                  SizedBox(height: 5,),
  ...
  _buildPassAuth(BuildContext context,ForgotPasswordOTPBloc bloc) {
    return BlocBuilder<ForgotPasswordOTPBloc,ForgotPasswordOtpState>(
        ...
        return WidgetInput(
          ...
          Fix: Text("Mã xác thực",style:TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.w600,fontSize: 14)),
        );
        });
  }
}
