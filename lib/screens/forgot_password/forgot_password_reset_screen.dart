...
import 'package:gen_crm/screens/forgot_password/index.dart';
...
class _ForgotPasswordResetScreenState extends State<ForgotPasswordResetScreen> {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  children: [
                                    Text("Cập nhật mật khẩu",style: TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.bold,fontSize: 20),),
                                    SizedBox(height: 5,),
                                    Text("Nhập mật khẩu mới để đăng nhập tài khoản",style: TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.w400,fontSize: 12),),
                                    AppValue.vSpaceMedium,
                                  ],
                                ),
                              ],
                ...
                if(cfPass.length<6 || newPass.length <6){
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      ...
                      bloc.add(FormResetPasswordSubmitted(newPass:newPass,username: username,email: email));
    ...
    return BlocBuilder<ResetPasswordBloc,ResetPasswordState>(
        builder: (context,state){
          return WidgetInput(
            ...
            Fix: Text("Mật khẩu",style:TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.w600,fontSize: 14)),
            obscureText: true,
            boxDecoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
  ...
  _buildTextFieldPasswordPressAgain(BuildContext context) {
    return WidgetInput(
      ...
      inputType: TextInputType.text,
      colorFix: Theme.of(context).scaffoldBackgroundColor,
      Fix: Text("Nhập lại mật khẩu",style:TextStyle(fontFamily: "Quicksand", fontWeight: FontWeight.w600,fontSize: 14)),
      obscureText: true,
      boxDecoration: BoxDecoration(
        borderRadius: BorderRadius.circular(10),
        border:Border.all(color: HexColor("#838A91")),
