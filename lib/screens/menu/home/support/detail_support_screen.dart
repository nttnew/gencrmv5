  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: WidgetText(title: Get.arguments[1],style: AppStyle.DEFAULT_18_BOLD,maxLine: 3,),
        leading: Padding(
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              Column(
                                children: List.generate(state.dataDetailSupport.length
                                    , (index) => Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        SizedBox(
                                        ...
                                        WidgetText(
                                          title: state.dataDetailSupport[index].group_name??'',
                                          style: TextStyle(
                                        ...
                                        Column(
                                          children: List.generate(state.dataDetailSupport[index].data!.length, (index1) => Column(
                                            children: [
                                              SizedBox(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: WidgetText(
                                                      title: state.dataDetailSupport[index].data![index1].value_field??'',
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            ShowDialogCustom.showDialogTwoButton(
                                                onTap2:()=> DetailSupportBloc.of(context).add(DeleteSupportEvent(id)),
