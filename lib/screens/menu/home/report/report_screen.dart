                      ...
                      if(state.dataLocation.isNotEmpty)
                        {
                          ...
                          return DropdownButton2(
                              ...
                              items: state.dataLocation.isNotEmpty ? state.dataLocation
                                  .map((items) => DropdownMenuItem<String>(
                                onTap: (){
                                  location = items[0];
                                  select3 = false;
                                ...
                                child: Text(items[1],
                                  ...
                                  : items.map((items) => DropdownMenuItem<String>(
                                value: items,
                                child: Text(items,
                                  style: AppStyle.DEFAULT_16_BOLD,
                                ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Doanh số",style: AppStyle.DEFAULT_18_BOLD.copyWith(color: COLORS.TEXT_BLUE_BOLD)),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Thực thu",style: AppStyle.DEFAULT_18_BOLD.copyWith(color: COLORS.TEXT_BLUE_BOLD),),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Số hợp đồng",style: AppStyle.DEFAULT_18_BOLD.copyWith(color: COLORS.TEXT_BLUE_BOLD),),
        ...
        children: [
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                Text('Ẩn chi tiết',style: AppStyle.DEFAULT_14.copyWith(color: COLORS.TEXT_BLUE_BOLD)),
                ...
                controller: _scrollController,
                  ...
                  itemBuilder: (context,index){
                    return GestureDetector(
                      onTap: (){
                        AppNavigator.navigateInfoContract(state.data[index].id!,state.data[index].name!);
                      },
                      child: Container(
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                      color: state.data[index].status_color != ""
                                          ? HexColor(state.data[index].status_color!)
                                          : COLORS.RED,
            ...
            return Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    flex: 2,
                    child:state.list.length>0? ListView.builder(
                      shrinkWrap: true,
                        itemBuilder: (context,index){
                          return Column(
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: indexProduct == index ? Colors.lime : Colors.blue.withOpacity(0.4),
                                      borderRadius: BorderRadius.circular(15)
                                  ),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text(state.list[index].name ?? "Chưa có",style: AppStyle.DEFAULT_16_BOLD.copyWith(color: COLORS.TEXT_BLUE_BOLD),),
                      ...
                      child: Center(
                        child: WidgetText(title:'Không có dữ liệu',style: AppStyle.DEFAULT_16_BOLD.copyWith(fontStyle: FontStyle.italic),),
                      ),
                    ),
                  ),
                  (indexProduct != -1) ? _bodyStep2()
                      : Container()
                ],
              ));
          } else {
                              ...
                              return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 5,),
                                    Text("${state.listSelect[index].doanh_so ?? 'Chưa xác định'}$money",style: AppStyle.DEFAULT_16,)
                                  ],
                                ),
                              );
                            },
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 12),
                                decoration: BoxDecoration(
                                    color: indexEmployee == index ? Colors.lime : Colors.blue.withOpacity(0.4),
                                    borderRadius: BorderRadius.circular(15)
                                ),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text(state.data[index].name ?? "Chưa có",style: AppStyle.DEFAULT_18_BOLD.copyWith(color: COLORS.TEXT_BLUE_BOLD),),
        ...
        children: [
          ...
          Padding(
            ...
            child: WidgetButton(
              ...
              text: "Done",backgroundColor:COLORS.BLUE,
            ),
          )
        ],
      ),
