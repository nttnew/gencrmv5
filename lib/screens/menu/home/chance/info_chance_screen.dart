                                                ...
                                                if(state.data[index].data != null)
                                                  return Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        AppValue.vSpaceTiny,
                                                        WidgetText(title: state.data[index].group_name??"",style: AppStyle.DEFAULT_16_BOLD,),
                                                        AppValue.vSpaceTiny,
                                                        Column(
                                                          children: List.generate(
                                                            state.data[index].data!.length,
                                                              ...
                                                              child: Row(
                                                                ...
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  Expanded(flex: 1,child: WidgetText(title: state.data[index].data![index1].label_field??'',style: AppStyle.DEFAULT_14.copyWith(color: Colors.grey),)),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Image.asset('assets/icons/hopdong.png'),SizedBox(width: 10),
                        InkWell(
                            onTap: (){
                              Get.back();
                              AppNavigator.navigateAddContract(id: id);
                            },
                            child: Text('Thêm hợp đồng',style: AppStyle.DEFAULT_16_BOLD.copyWith(color: Color(0xff006CB1)),))
                      ],),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        ...
                        ShowDialogCustom.showDialogTwoButton(
                            onTap2:()=> GetListDetailChanceBloc.of(context).add(InitDeleteChanceEvent(id)),
  ...
  _buildContent1(GetListDetailChanceBloc bloc){
    return BlocBuilder<GetListDetailChanceBloc, DetailChanceState>(
      builder: (context, state){
        ...
        else return Center(child: Text('Không có dữ liệu',style: AppStyle.DEFAULT_16_BOLD,));
      }
    );
  }
  _buildContent2(){
