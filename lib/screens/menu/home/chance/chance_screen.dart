          ...
          BlocBuilder<GetListChanceBloc, ChanceState>(
              builder: (context, state) {
                if (state is UpdateGetListChanceState){
                    ...
                    child: RefreshIndicator(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          //             SizedBox(width: 10,),
                          //             Text('Đang xử lý',style:  AppStyle.DEFAULT_LABEL_PRODUCT.copyWith(color: COLORS.TEXT_COLOR)),
                          //           ],
                          //         ),
                          //         SizedBox(height: 15,),
                          //         Row(
                  ...
                  child: WidgetText(title:'Không có dữ liệu',style: AppStyle.DEFAULT_18_BOLD,),
                ));
              }
          ),
        ],
