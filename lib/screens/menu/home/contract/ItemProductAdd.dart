          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 3,),
                WidgetText(
                  title: "Mã sản phẩm: "+"${widget.data.item.product_code??''}",
                  style: AppStyle.DEFAULT_14_BOLD.copyWith(color: COLORS.TEXT_GREY),
                ),
                SizedBox(height: 3,),
                WidgetText(
                  title: "Giá: "+"${widget.data.item.sell_price!=null? AppValue.format_money(double.parse(widget.data.item.sell_price!)):''}"+"VNĐ",
                  style: AppStyle.DEFAULT_14_BOLD.copyWith(color: COLORS.TEXT_GREY),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.symmetric(horizontal: 10),
                      child: WidgetText(
                        title: "Giảm giá: "+widget.data.giamGia+widget.data.typeGiamGia,
