...
//
// class AddClueScreen extends StatefulWidget {
//   const AddClueScreen({Key? key}) : super(key: key);
//
//   @override
//   State<AddClueScreen> createState() => _AddClueScreenState();
// }
//
// class _AddClueScreenState extends State<AddClueScreen> {
//   bool isSelect =true;
//
...
//         title: Text(MESSAGES.ADD_CLUE, style: TextStyle(color: Colors.black,fontFamily: "Montserrat",fontWeight: FontWeight.w700,fontSize: 16)),
//         leading: _buildBack(),
...
//             borderRadius: BorderRadius.circular(10)
//         ),
//         resultIcon: Icon(Icons.arrow_drop_down,color: COLORS.GREY,),
