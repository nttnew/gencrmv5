        ...
        children: [
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                    color:widget.data!.color!=null? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR,
          ...
          Row(
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: AppValue.widths * 0.03),
                child: WidgetText(title: widget.data!.customer_name??'',style: NameCustomerStyle(),),
              ),
          ...
          Row(
            children: [
              SvgPicture.asset("assets/icons/icon3svg",color:widget.data!.color!=null? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR,),
              Padding(
                padding: EdgeInsets.only(left: AppValue.widths * 0.03),
                child: SizedBox(
                    width: AppValue.widths*0.5,
                    child: WidgetText(
                     title: widget.data!.status??'',style: AppStyle.DEFAULT_14.copyWith(color:widget.data!.color!=null? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR),)),
              ),
            ],
          ),
          // SizedBox(height: AppValue.heights*0.01),
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                    width: AppValue.widths * 0.5,
                    child: WidgetText(
                      title: "Tổng tiền: "+"${widget.data!.total_value??''}"+"đ"
                      ,
                      style: OrtherInforCustomerStyle(),)),
              ),
              Spacer(),
