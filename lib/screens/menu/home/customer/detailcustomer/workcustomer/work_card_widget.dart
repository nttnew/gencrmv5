...
class _WorkCardWidgetState extends State<WorkCardWidget> {
    ...
    return Container(
      child: Column(
        children: [
          Row(
            ...
            children: [
              SizedBox(
                ...
                child: WidgetText(
                  title: widget.data!.name??'', style: NameCustomerStyle(),),
              ),
              Spacer(),
              Container(
                decoration: BoxDecoration(
                    color:widget.data!.color!=""? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR,
          ...
          Row(
            children: [
              SvgPicture.asset("assets/icons/avatar_customer.svg",color: COLORS.ORANGE_IMAGE,),
              Padding(
                padding: EdgeInsets.only(left: AppValue.widths * 0.03),
                child: WidgetText(title: widget.data!.user??'',style: AppStyle.DEFAULT_14,),
              ),
          ...
          Row(
            children: [
              SvgPicture.asset("assets/icons/icon3svg",color: widget.data!.color!=""? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR,),
              Padding(
                padding: EdgeInsets.only(left: AppValue.widths * 0.03),
                child: SizedBox(
                    width: AppValue.widths*0.5,
                    child: WidgetText(
                      title: widget.data!.status??'',style: AppStyle.DEFAULT_14.copyWith(color: widget.data!.color!=""? HexColor(widget.data!.color!):COLORS.PRIMARY_COLOR),)),
              ),
            ],
          ),
          SizedBox(height: AppValue.heights*0.01),
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                    width: AppValue.widths*0.5,
                    child: WidgetText(
                        title: AppValue.formatDate(widget.data!.start_date!),style: OrtherInforCustomerStyle())),
              ),
              Spacer(),
              SvgPicture.asset("assets/icons/question_answer.svg"),
              SizedBox(width: AppValue.widths*0.01,),
              WidgetText(title: widget.data!.total_note??'',style: TextStyle(color: HexColor("#0052B4"),),),
            ],
          ),
  ...
  TextStyle OrtherInforCustomerStyle() => TextStyle(color: HexColor("#263238"),fontFamily: "Roboto",fontWeight: FontWeight.w400,fontSize: 14);
