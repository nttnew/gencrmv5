...
import 'package:gen_crm/screens/menu/home/customer/form_dropdown.dart';
...
class _FormEditState extends State<FormEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: WidgetText(title: "Sửa thông tin",
              style: TextStyle(
                  color: Colors.black,
                      ...
                      for(int i=0;i<state.listEditData.length;i++){
                        ...
                        for(int j=0;j<state.listEditData[i].data!.length;j++){
                          addData[i].data.add(ModelDataAdd(
                              ...
                              value: state.listEditData[i].data![j].field_set_value.toString(),
                              required: state.listEditData[i].data![j].field_require
                          ));
                        }
                      }
                      return Column(
                            ...
                            children: List.generate(
                                state.listEditData.length,
                                  ...
                                  children: [
                                    ...
                                    state.listEditData[index].group_name!=null? WidgetText(
                                        title:
                                          ...
                                          state.listEditData[index].data!.length,
                                              (index1) {
                                                if(state.listEditData[index].data![index1].field_id=="246")
                                                  customer_id=state.listEditData[index].data![index1].field_set_value.toString();
                                                return state
                                                    .listEditData[index]
                                                    .data![index1]
                                                    .field_special ==
                                                    "none-edit"
                                                    ? (
                                                    state.listEditData[index].data![index1].field_id=="12547"||state.listEditData[index].data![index1].field_id ==
                                                        "1472"?
                                                        ...
                                                        builder: (context, stateA) {
                                                          if (stateA is SuccessPhoneState)
                                                          {
                                                            ...
                                                            return _fieldInputCustomer(
                                                                ...
                                                                index1,
                                                                noEdit: true,
                                                                value: state.listEditData[index]
                                                                    .data![index1].field_value!
                                                            );
                                                          }
                                                        }):_fieldInputCustomer(
                                                        state.listEditData[index]
                                                ...
                                                BlocBuilder<ContactByCustomerBloc, ContactByCustomerState>(
                                                        ...
                                                        return InputDropdown(
                                                            ...
                                                            onSuccess:(data) {
                                                              addData[index]
                                                                  .data[index1]
                                                                  .value = data;
                                                              if(state.listEditData[index].data![index1].field_id!="107")
                                                    ...
                                                    onSuccess:(data) {
                                                      addData[index]
                                                          ...
                                                          .value = data;
                                                      if (state.listEditData[index].data![index1].field_id =="107"||
                                                          state.listEditData[index].data![index1].field_id =="128")
                                                      {
                                                ...
                                                index]
                                                  ...
                                                  onSelect:
                                                    ...
                                                    addData[index]
                                                        .data[index1]
                                                        .value = (date.millisecondsSinceEpoch / 1000).floor();
                                                  },
                                                  dateText:(state
                                                      .listEditData[index]
                                                      .data![index1].field_set_value!=""&&state
                                                      .listEditData[index]
                                                      .data![index1].field_set_value!=null)? AppValue.formatDate(DateTime.fromMillisecondsSinceEpoch(state
                                                      .listEditData[index]
                                                      .data![index1].field_set_value*1000).toString()):"",
                                                  onInit:
                                                      () {
                                                        if(state
                                                            .listEditData[index]
                                                            .data![index1].field_set_value!=""&&state
                                                            .listEditData[index]
                                                            .data![index1].field_set_value!=null){
                                                          addData[index]
                                                              .data[index1]
                                                              .value=state
                                                              .listEditData[index]
                                                              .data![index1].field_set_value;
                                                        }
                                                        else{
                                                          DateTime date=DateTime.now();
                                                          addData[index]
                                                              .data[index1]
                                                              .value = (date.microsecondsSinceEpoch / 1000000).floor();
                                                        }
                                                  },
                                                ...
                                                FieldInputPercent(
                                                  ...
                                                  onChanged: (text){
                                                    ...
                                                    state
                                                        .listEditData[
                                                    index]
                                                        .data![index1],index,index1,value: state.listEditData[index].data![index1].field_set_value.toString());
                                              }),
                                    )
                                  ],
                                )),
  ...
  Widget _fieldInputCustomerType(
      List<List<dynamic>> dropdownItemList, String label,Function onSuccess,String value,String set_value,int required) {
    List dropdow = [];
    int indexDefault=-1;
    for (int i = 0; i < dropdownItemList.length; i++) {
      if(dropdownItemList[i][1]!=null && dropdownItemList[i][0] !=null)
      {
        ...
        if(dropdownItemList[i][0].toString()==set_value){
          indexDefault=i;
        }
      }
    }
          ...
          Container(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  //       size: 25,
                  //     ),
                  //     dropdownList: dropdow,
                  //     unselectedItemTS: AppStyle.DEFAULT_12,
                  //     selectedItemTS:
                  //         AppStyle.DEFAULT_12_BOLD.copyWith(color: COLORS.BLUE),
                  //     dropdownItemPadding:
                  //         EdgeInsets.symmetric(vertical: 0, horizontal: 16),
                  //     dropdownItemHeight: 30,
                  //     dropdownHeight:
                  //         dropdow.length > 6 ? (6 * 38) : dropdow.length * 38,
                  //     onChange: (e) {
                  //       // addData[index].data[index1].value=e['value'];
                  //       onSuccess(e['value']);
                  //     },
                  //     resultTS: TextStyle(
                  //       fontSize: 11,
                  ...
                  //       color: HexColor("#838A91"),
                  //     ),
                  //     defaultValue:indexDefault!=-1? dropdow[indexDefault]:null,
                  //     resultHeight: 45,
  ...
  void onClickSave() {
    ...
    for(int i=0;i<addData.length;i++){
      for(int j=0;j<addData[i].data.length;j++){
        ...
        else data["${addData[i].data[j].label}"]="";
      }
    }
    if(check==true){
      showDialog(
...
class WidgetInputMulti extends StatefulWidget {
  WidgetInputMulti({Key? key, required this.data,required this.onSelect,required this.value,required this.onRemove}) : super(key: key);
